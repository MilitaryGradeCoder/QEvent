...
const router = useRouter();
  return (
    <div className="hover-inverse group w-[20%]  h-fit flex text-center justify-center transform transition-transform duration-400 hover:scale-110 hover:bg-gradient-to-r hover:from-orange-200 hover:to-white text-dark border-slate-400 border rounded-md px-8 py-2.5 w-full">
